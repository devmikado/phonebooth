...
# STATIC_URL = 'https://phoneboothb2b.progfeel.co.in/static/'
STATIC_URL = "/static/"
...
SOCIAL_AUTH_FACEBOOK_SCOPE = ['email', 'pages_read_user_content', 'pages_manage_posts', 'pages_manage_engagement', 'pages_read_engagement'] # add this
